/*
  ...
  - You are about to drop the column `soil` on the `Data` table. All the data in the column will be lost.
  - Added the required column `temprature` to the `Data` table without a default value. This is not possible if the table is not empty.
